...
exports.CheckoutStatus = exports.Checkout = void 0;
...
(function (CheckoutStatus) {
  CheckoutStatus["in_progress"] = "in progress";
...
var Checkout = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.Column)({
  ...
  function Checkout() {
    ...
    (0, _initializerDefineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "cart_id", _descriptor, (0, _assertThisInitialized2["default"])(_this));
  ...
  (0, _createClass2["default"])(Checkout, [{
    ...
    value: function beforeInsert() {
      this.id = (0, _utils.generateEntityId)(this.id, "checkout");
    }
  }]);
  return Checkout;
}(_medusa.BaseEntity), (_descriptor = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "cart_id", [_dec2, _dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "beforeInsert", [_dec6, _dec7, _dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "beforeInsert"), _class2.prototype)), _class2)) || _class);
